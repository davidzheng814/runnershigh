...
app.run(function($rootScope) {
  ...
  changeSystemDate = function() {
    ...
    schedVars.myProgress = [
        ...
        {date:new Date("5/8/16"),distance:7.5,pace:8.2,activity:'running'},
        ...
        {date:new Date("5/15/16"),distance:8.3,pace:8.8,activity:'running'},
        ...
        {date:new Date("5/22/16"),distance:9.5,pace:8.2,activity:'running'},
        ...
        {date:new Date("5/29/16"),distance:10.3,pace:8.3,activity:'running'},
